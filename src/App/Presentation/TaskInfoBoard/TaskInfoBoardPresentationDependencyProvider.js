 ...
 * @description Provides TaskInfoBoard presentation dependencies.
 */
export class TaskInfoBoardPresentationDependencyProvider extends AbstractDependencyProvider {
...
export default TaskInfoBoardPresentationDependencyProvider;
